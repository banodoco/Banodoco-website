...
with st.expander("Who is behind this?"):
  st.write('''This is written by Peter O'Malley, or POM. I do a little bit of everything. You can find me on Twitter [here](https://twitter.com/pom_I_moq/), Github [here](https://github.com/peteromallet), see some of my art [here](https://www.youtube.com/@misterpeterface). I work with [Matt30](https://x.com/cubiq), my cofounder who's been instrumental in building our tools and infrastructure in the ecosystem. You can find his Github [here](https://github.com/cubiq).
           
In addition to this, we support and work with talented people who build open infrastructure on top of the ecosystem like [Piyush Kumar](https://x.com/thisispiyushK) (also known as lone_samurai) and [Kosinkadink](https://github.com/kosinkadink), and share bounties for others to complete tasks that help the ecosystem and are aligned with our goals.
