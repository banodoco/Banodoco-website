...
from Home import cta,interpolation_element
...
st.image('https://banodoco.s3.amazonaws.com/images/motion.png')
st.write("They can iterate through different possibilities:")
st.image('https://banodoco.s3.amazonaws.com/images/iteration.png')
st.write("And because they only generating images, they can see the results in **seconds**:")
st.image('https://banodoco.s3.amazonaws.com/images/changes.png')
...
with outputcol1:
  st.image('https://banodoco.s3.amazonaws.com/images/steerable-motion-output_1.png')
with outputcol2:
  st.image('https://banodoco.s3.amazonaws.com/images/steerable-motion-output_2.png')
