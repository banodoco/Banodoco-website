...
with h1:
    ...
    st.markdown("For AI to reach its creative potential, artistic control is key - it's the difference between something feeling like it was made by you rather than for you. We believe that one of the best ways to control video right now is using images and we made Dough to help you do that!")
...
st.markdown('#### Some weird, beautiful, and interesting things people have made with Dough and [Steerable Motion](https://github.com/banodoco/steerable-motion), the technology behind Dough')
...
with bottom2:
    st.info("###### For everyone else, we have a Discord bot that works on any device - even your phone!")
    st.markdown('''
    - **Cost:** Our costs + 40%
...
We plan to share profits from Dough with people who contribute to the technology and movement behind it. Here's how we plan to share profits:

- 25% to the people who build infrastructure and models on which the technology is built
- 25% to people who build workflows and technology on top of infrastructure
