...
st.write("Our goal is to make Banodoco into a great business that can support the development of open source AI art ecosystem - by creating a company that earns money & is an extremely attractive investment to those who believe in our mission and open source.")
...
st.write("Instead, we're choosing a structure that aims to incentivise and inspire open source ingenuity in the right direction throughout a far longer period - by sharing 100% of our equity with contributors over the first 8.5 years:")
...
st.write("How this is distributed will constantly evolve as we figure out the best approach - but we hope to arrive at a consistent approach over the first 2 years that is fair and inspires the right kind of contributions.")
...
st.markdown("I think that this is a very fair question. - I could in theory go back on this when the company is valuable and have way more money for fancy lawyers. In fact, there are loads of ways people screw others in all kinds of equity arrangements. All I can say is that it that my goal is to do stuff like this for the rest of my life - doing anything that would make me untrustworthy would be silly and long-term stupid.")

st.markdown("**“Does this mean that people who get equity will control the company?”**")
st.markdown("Honestly, I don’t know about this yet - my perception is that most DAOs and efforts at distributed control have been very chaotic. It could make sense long-term to have a “Benevolent dictator for life” set-up with checks and balances, or something like a distributed rule. Right now, I don’t know but am slightly biasing towards this.")

st.markdown("**“If the equity becomes valuable, how will I be able to sell it?”**")
st.markdown("This is TBC but many private startups like SpaceX offer equity holders the opportunity to sell at pre-determined times and we’ll probably do something similar. What we don't want is for our equity to become like a token that's speculatively bought and sold, so will put constraints to avoid this.")

st.markdown("**“What about crypto?”**")
st.markdown("It could in theory be possible to implement this using crypto - if you have any ideas on how to achieve this in a way that isn’t bullshitty and aligns with the above goals, please get in touch.")

st.markdown("**“What about tax?”**")
st.markdown("We’ll try to set it up in a way that tax is only due upon actual realised gains - meaning, you’d only pay based on actual money you make. Again, I'll need to hire fancy lawyers and accountants to figure this out.")

st.markdown("**“What happens if the company is sold before the equity is allocated?”**")
st.markdown("Firstly, our intention is to build this into a self-sustaining entity long-term. However, if we do get purchased by another company, equity will be distributed proportionally based on the allocations made to date. For example, if someone holds 1% of the equity and 33.3% of the total equity has been allocated, they would receive 3% of the purchase price.")
