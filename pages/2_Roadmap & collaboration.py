...
st.markdown("***")
# Header: Equity for significant collaborators
...
st.write("When we raise funding, we plan to compensate significant contributors, in addition to bringing on-board full-time, long-term collaborators. If you're interested in any of the above projects, please **join our Discord [here](https://discord.gg/cY55cW93XP)** to see more details.")
