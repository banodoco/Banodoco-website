...
with footer1:  
  ...
  st.write("AI has the potential to equip every individual with equivalent master-level artistic assistance. However, it's also inherently chaotic - each model can be used in vastly different ways to achieve wildly different results. Think of each as a prodigy, full of potential that they may or may not reach - depending on the instruction, inspiration and structure that they receive.")
