...
st.write("We believe that empowering this community to create tools that any artist can easily use is how to harness the chaotic potential of open source AI. To do this, our plan is create a tool builder and infrastucure that allows them them to create tools that bring their discoveries and perspectives on how to leverage AI to the world.")
st.write("In doing this, we want to create an economic system that rewards people who contribute at every level, sharing both the revenue that these tools earn and ownership in our company with those who drive the ecosystem in various ways.")
