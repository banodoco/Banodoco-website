// Spike A — anatomy mirror.
// The hero scene does not export its cap form-language functions, and Spike A
// may not modify mushroom-scene.js. These are byte-faithful copies of the
...
//     shortest rise.
export const EXITS = [
  { id: 'artcompute', label: 'ArtCompute',       az: 5.50, riseMin: 2.3, riseMax: 3.0, lean: 0.52, tone: 0.66 },
  { id: 'arca',       label: 'Arca Gidan Prize', az: 4.62, riseMin: 2.7, riseMax: 3.4, lean: 0.38, tone: 0.74 },
  { id: '2rp',        label: '2RP',              az: 3.78, riseMin: 1.8, riseMax: 2.4, lean: 0.42, tone: 0.60 },
];
