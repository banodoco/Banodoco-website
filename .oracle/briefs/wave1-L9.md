# Luna Exploration Wave 1 — L9 Recurring failure and security patterns
...
Primary surfaces: catch blocks; global handlers; innerHTML; external fetch/media; cache-query imports; storage; event installation

Questions to answer: Find repeated unsafe failure handling, trust-boundary mistakes, injection or URL risks, cancellation inconsistency, swallowed failures, and visitor-visible fallback gaps. Require at least three sites before proposing a shared pattern.
