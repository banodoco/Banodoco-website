# Luna Exploration Wave 1 — L8 Tooling build test and deploy
...
Primary surfaces: package.json; lint/Madge; tools/; serve.py; build/release/public manifests; capture/bake tooling

Questions to answer: Find false greens, missing production roots/scenarios, mutating checks, generated-artifact drift risks, static-deploy hazards, Range semantics bugs, and documentation/executable mismatch.
