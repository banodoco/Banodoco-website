# Luna Exploration Wave 1 — L6 Performance
...
Primary surfaces: frame loops; TAA/pixel-ratio policy; UI projection/layout; media/card warming; asset sizes; chapter preparation

Questions to answer: Find measured or instrumentable CPU, GPU, frame, layout, network, and memory risks. Separate facts from hypotheses; identify repeated unbounded work and missing observability.
