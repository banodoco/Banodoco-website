# Luna Exploration Wave 1 — L7 Maintainability and coherence
...
Primary surfaces: all live first-party modules excluding archive vendor generated outputs

Questions to answer: Find duplicated policy/data, stale compatibility paths, overbroad facades, misleading contracts/comments, dead or accidental complexity, and recurring awkward patterns. Reject size-only and aesthetic findings.
