# Luna Exploration Wave 1 — L1 Architecture and control flow
...
Primary surfaces: main.js; journey/journey.js; journey/chapter-registry.js; journey/structure.js; journey/chapter-interactions.js; journey/rail.js

Questions to answer: Map entry-to-frame and input-to-route control flow. Identify hidden globals, import cycles, broad interfaces, ownership ambiguity, non-local mutation, and boot/fallback boundaries.
