...
export const CONTENT = {
  chapters: {
    ...
    owned: {
      nav: 'Owned',
      heading: 'Owned by everyone who builds it.',
      sub: 'Ownership here is literal: 100% shared, granted 1% per month, split between artists, core engineers, and knowledge creators.',
    },
    final: {
      nav: 'Final',
  ...
  contributors: [
    {
      ...
      role: 'Artist',
      blurb: 'This node stands in for a motion artist whose work has helped shape what’s possible in the ecosystem. Their name and story will appear here once we have their consent to share it — their ownership stake is already in place.',
      consent: false,
      seed: 3,
    },
    {
      ...
      role: 'Artist',
      blurb: 'A placeholder for a generative painter who has pushed open image models toward genuinely new territory. Ownership here is real; the profile is simply waiting on consent.',
      consent: false,
      seed: 11,
    },
    {
      ...
      role: 'Artist',
      blurb: 'This node represents a contributor working at the intersection of sound and image — a real person whose ownership share is already accruing, awaiting permission to show their name and work.',
      consent: false,
      seed: 19,
    },
    {
      ...
      role: 'Artist',
      blurb: 'A stand-in for an artist who brings open AI tools into live, in-the-room performance. Their profile will be filled in as soon as they’ve consented to be shown.',
      consent: false,
      seed: 27,
    },
    {
      ...
      role: 'Artist',
      blurb: 'This node holds space for a collage and compositing artist whose work sits across several Banodoco tools. A real profile, name, and photo will replace this once consent is confirmed.',
      consent: false,
      seed: 35,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'A placeholder for a pipeline engineer whose work keeps PYPE and the tools built on it running. Their ownership stake reflects that infrastructure work, waiting on consent to publish their profile.',
      consent: false,
      seed: 8,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'This node stands in for a rendering engineer whose contributions shape how the ecosystem’s tools actually perform. A real profile will replace this placeholder once they’ve consented.',
      consent: false,
      seed: 16,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'A stand-in for an engineer who builds and maintains the shared infrastructure everyone else depends on. Ownership is already granted; the name is pending consent.',
      consent: false,
      seed: 24,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'This node represents a contributor who connects new open models into Banodoco’s tools. Their profile awaits consent — their contribution and ownership are already part of the record.',
      consent: false,
      seed: 32,
    },
    {
      ...
      blurb: 'A placeholder for a moderator who keeps Banodoco’s community spaces useful and welcoming. Their ownership share reflects that ongoing work, pending consent to share their name.',
      consent: false,
      seed: 5,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'This node stands in for a writer who turns hard-won knowledge into documentation others can actually use. A real profile will appear here once consent is confirmed.',
      consent: false,
      seed: 13,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'A stand-in for a contributor who tests, documents, and shares workflows so the rest of the community doesn’t have to start from zero. Their ownership stake is already in place, awaiting consent.',
      consent: false,
      seed: 21,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'This node holds space for someone who teaches the ecosystem’s tools through tutorials and walkthroughs. Their profile will be published as soon as they’ve consented.',
      consent: false,
      seed: 29,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'A placeholder for a contributor who curates the datasets, references, and archives the community draws on. Ownership is already granted; only the name is pending consent.',
      consent: false,
      seed: 37,
    },
  ],
  ...
  footer: {
    ...
    legal: '© Banodoco. Open-source infrastructure for the AI art ecosystem.',
  },
};
