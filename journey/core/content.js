  ...
  nodes: {
    ...
    community: {
      ...
      card: {
        title: 'Community',
        body: [
          'Underneath everything else sits the commons: artists, builders, and curious newcomers overlapping, trading work in progress, keeping each other going.',
    ...
    hivemind: {
      ...
      card: {
        title: 'Hivemind',
        body: [
          'A discovery is only as good as the community’s memory of it. Hivemind keeps that memory — the record that outlives the conversation that produced it.',
    ...
    tworp: {
      ...
      spotlight: {
        title: '2RP',
        body: [
          'Someone has to write it down properly. 2RP is Banodoco’s publication for rigorous research in AI art — treating the field with the same seriousness as the work it studies.',
  ...
  contributors: [
    {
      ...
      role: 'Artist',
      blurb: 'Motion work that made other people raise what they thought the tools could do.',
      consent: false,
      seed: 3,
    },
    {
      ...
      role: 'Artist',
      blurb: 'Paintings that treat a generative model as a brush, not a vending machine.',
      consent: false,
      seed: 11,
    },
    {
      ...
      role: 'Artist',
      blurb: 'Sound and image made to move together — work that listens as much as it looks.',
      consent: false,
      seed: 19,
    },
    {
      ...
      role: 'Artist',
      blurb: 'Open AI tools carried onto real stages, in front of real rooms.',
      consent: false,
      seed: 27,
    },
    {
      ...
      role: 'Artist',
      blurb: 'Collage and compositing across half the ecosystem’s tools at once.',
      consent: false,
      seed: 35,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'The pipeline work that everything else quietly runs on.',
      consent: false,
      seed: 8,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'Rendering that makes the tools feel fast enough to think with.',
      consent: false,
      seed: 16,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'Shared infrastructure, built and maintained so nobody else has to.',
      consent: false,
      seed: 24,
    },
    {
      ...
      role: 'Core Engineer',
      blurb: 'New open models wired into the ecosystem within days of their release.',
      consent: false,
      seed: 32,
    },
    {
      ...
      blurb: 'Community spaces kept useful, welcoming, and worth returning to.',
      consent: false,
      seed: 5,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'Hard-won knowledge turned into documentation people actually use.',
      consent: false,
      seed: 13,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'Workflows tested, documented, and shared so nobody starts from zero.',
      consent: false,
      seed: 21,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'Tutorials that turn intimidating tools into an afternoon’s experiment.',
      consent: false,
      seed: 29,
    },
    {
      ...
      role: 'Knowledge Creator',
      blurb: 'The datasets, references, and archives the whole community draws on.',
      consent: false,
      seed: 37,
    },
  ],
