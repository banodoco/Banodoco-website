 ...
 * Used for "open in new tab" links
 */
 ...
 * Used for "continue" or "next" CTAs
 */
...
/**
 * Arrow pointing down
 * Used for "scroll down" or "learn more" CTAs
 */
 ...
 * Used for carousel/pagination previous buttons
 */
export const ChevronLeftIcon = ({ className }: IconProps) => (
  <svg className={cn("w-4 h-4", className)} fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={3}>
 ...
 * Used for carousel/pagination next buttons
 */
...
/**
 * X/Close icon
 * Used for closing modals, lightboxes, etc.
 */
...
/**
 * Calendar icon
 * Used for event-related content
 */
