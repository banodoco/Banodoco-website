...
import { grants, transfers, type OwnershipData } from '@/components/sections/Ownership/data';
import { EXTERNAL_LINKS, OWNERSHIP_ASSET_URLS } from '@/lib/externalLinks';

type OwnershipTab = 'grants-transfers' | 'ownership-to-date';

const OwnershipIntroSection = () => (
  <>
    <div className="space-y-6 text-base md:text-lg leading-relaxed text-gray-800 relative">
      <div className="float-none md:float-right md:clear-right max-w-full md:max-w-[45%] md:ml-6 mb-6">
        <img
          src={OWNERSHIP_ASSET_URLS.typicalStartupEquity}
      ...
      <div className="float-none md:float-right md:clear-right max-w-full md:max-w-[45%] md:ml-6 mb-6">
        <img
          src={OWNERSHIP_ASSET_URLS.openSourceNative}
        ...
        content={
          <div className="space-y-3">
            ...
            <div className="float-none md:float-left md:max-w-[45%] md:mr-6 mb-6 max-w-full">
              <img
                src={OWNERSHIP_ASSET_URLS.structureDiagram}
...
interface GrantsAndOwnershipSectionProps {
  activeTab: OwnershipTab;
  onTabChange: (tab: OwnershipTab) => void;
  ownershipData: OwnershipData[];
  ownershipLoading: boolean;
  ownershipError: string | null;
}

const GrantsAndOwnershipSection = ({
  activeTab,
  onTabChange,
  ownershipData,
  ownershipLoading,
  ownershipError,
}: GrantsAndOwnershipSectionProps) => (
  <>
    ...
    <div className="mt-8">
      <div className="flex gap-2 mb-6 border-b border-gray-300">
        <button
          onClick={() => onTabChange('grants-transfers')}
        ...
        <button
          onClick={() => onTabChange('ownership-to-date')}
          className={`px-5 py-2 text-sm transition-colors relative ${
  ...
  <>
    ...
    <div className="space-y-3">
      <AccordionItem
        ...
        content={
          <p>
            You can read more about what we're up to <a href={EXTERNAL_LINKS.banodocoHome} className="text-blue-600 hover:underline">here</a> - more coming soon.
          </p>
        }
      />
      <AccordionItem
      ...
      <AccordionItem
        ...
        content={
          <p>
            DM me on <a href={EXTERNAL_LINKS.discordInvite} className="text-blue-600 hover:underline">our Discord</a>!
          </p>
        }
      />
    </div>
...
const OwnershipPage = () => {
  const [activeTab, setActiveTab] = useState<OwnershipTab>('grants-transfers');
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f3] text-gray-900">
      <div className="max-w-4xl mx-auto px-6 md:px-16 py-12 md:py-16">
        ...
        <OwnershipIntroSection />
        <DisclaimersSection />

        <GrantsAndOwnershipSection
          activeTab={activeTab}
