 ...
 * -------------------------------------------------------------- */
{
  ...
  fetchController.manifest = {
    version: 1,
    chapters: { owned: { file: 'owned.bin', sha256: 'x', keys: [], payload: { hello: 'owned' } } },
  };
 ...
 * -------------------------------------------------------------- */
{
  ...
  fetchController.manifest = {
    version: 1,
    chapters: { owned: { file: 'owned.bin', sha256: 'x', keys: [], payload: {} } },
  };
 ...
 * -------------------------------------------------------------- */
{
  ...
  fetchController.manifest = {
    version: 1,
    chapters: { owned: { file: 'owned.bin', sha256: 'x', keys: [], payload: { n: 1 } } },
  };
  fetchController.bins = { 'static/geom/owned.bin': new ArrayBuffer(8) };
