...
const NOT_IN_CHAIN = {
  ...
  'tools/test-initial-render-target-size.mjs': 'wired into the `test:harness` script, which `check` also runs',
  'tools/test-intro-clock.mjs': 'wired into the `test:harness` script, which `check` also runs',
  'tools/test-serve-range.mjs': 'wired into the `test:harness` script, which `check` also runs',
