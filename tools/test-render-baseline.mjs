...
check('R15', 'organism/spores.js really carries both pinned lines, once each',
  ...
  [['const randT = makeRng(9127);', true, 1, [777]],
    ['return () => { s = (s * 1664525 + 1013904223) >>> 0; return s / 4294967296; };', true, 1, [675]]]);
...
// EXACT value, not a range: this pin's whole job is to trip on the NEXT
// unclaimed change to this file.
check('R16', 'organism/spores.js sha256', sporePin.fileSha256,
  'e0250ca7f326dd1de439d0b22a8df67688ccba2e1d34ba66bf1777c01e4767e4');
...
const CANCEL_RAF_SITES = [
    ...
    "organism/intro.js :: cancelAnimationFrame(rampRaf);",
  ];
