...
// Keep the good and deliberately perturbed loader arms identical everywhere
// except the variable each scenario claims to mutate. The shared baseline is
// a complete strict-schema chapter with one exact eight-byte packed window.
 ...
 * ------------------------------------------------------------------ */
{
  async function scenario(version, tag) {
    ...
    fetchController.manifest = { version, chapters: { owned: validChapter('owned') } };
